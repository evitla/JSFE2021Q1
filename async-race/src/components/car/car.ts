...
export class Car extends BaseComponent {
  ...
  readonly removeButton = new Button('remove', ['secondary-btn', 'remove-btn']);

  readonly startEngineButton = new Button('A', ['start-engine-btn']);

  readonly stopEngineButton = new Button('B', ['stop-engine-btn'], true);
  ...
  private renderGeneralButtons() {
    ...
    generalButtons.appendChild(this.selectButton.element);
    generalButtons.appendChild(this.removeButton.element);

    this.track.appendChild(generalButtons);
  }
    ...
    const image = `
      ...
      <svg viewBox="0 0 720 720" preserveAspectRatio="xMidYMin slice"
        ...
        <g inkscape:label="Layer 1" inkscape:groupmode="layer" id="layer1" transform="translate(-8.835034,-24.54683)">
          ...
          <path style="fill:${color};fill-opacity:1;fill-rule:evenodd;stroke:black;stroke-width:9;stroke-linecap:butt;
          ...
          <rect style="fill:${color};fill-opacity:1;stroke:black;stroke-width:9;stroke-miterlimit:4;stroke-dasharray:none;
